																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																			...
																			<td><span class="badge badge-info"><i class="fa fa-bars"></i> Pending</span></td>
																		   ...
																		   <?php 
																			...
																			<td><span class="badge badge-warning"><i class="fa fa-cog fa-spin"></i> On The Way!</span></td>
																			...
																			<td><span class="badge badge-success"><i class="fa fa-check-circle"></i> Delivered</span></td>
																			...
																			<td><span class="badge badge-danger"><i class="fa fa-close"></i> Cancelled</span></td> 
																			<?php 
																			} 
																			?>
																						<?php																									
