			  ...
			  <ul class="sidebar-menu" data-widget="tree">	
				...
				<li class="treeview">
				  ...
				  <ul class="treeview-menu">
					...
					<li class="active"><a href="add_menu.php"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Add Menu</a></li>
							...
							<form action='' method='post'  enctype="multipart/form-data" class="clearfix">
								<div class="row">
								  <div class="col-md-6 mb-3">
									...
									<input type="text" class="form-control" placeholder="Enter Dish Name" name="d_name" >
								  </div>
								  <div class="col-md-6 mb-3">
									<label class="form-label">Description</label>
									<input type="text" class="form-control" placeholder="Enter Description" name="about">
								  </div>
								  <div class="col-md-6 mb-3">
								   ...
								   <div class="col-md-6 mb-3">
									<label class="form-label">Image</label>
									  <div class="input-group mb-3">
										  ...
										  <input  class="bg-white form-control" type="file" name="file"  id="lastName">
									  </div>
								  </div>
								...
								<a href="add_menu.php"><button type="button" class="waves-effect waves-light btn btn-dark mb-5"><i class=" ti-close"></i> Cancel</button></a>
