			  ...
			  <ul class="sidebar-menu" data-widget="tree">	
				...
				<li class="treeview">
				  ...
				  <ul class="treeview-menu">
					...
					<li class="active"><a href="add_restaurant.php"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Add Restaurant</a></li>
							...
							<form action='' method='post'  enctype="multipart/form-data" class="clearfix">
								<div class="row">
								  <div class="col-md-6 mb-3">
									...
									<input type="text" class="form-control" placeholder="Restaurant Name" name="res_name" >
								  </div>
								  <div class="col-md-6 mb-3">
									<label class="form-label">Bussiness E-mail</label>
									<input type="text" class="form-control" placeholder="Bussiness E-mail" name="email">
								  </div>
								  <div class="col-md-6 mb-3">
								  ...
								  <div class="col-md-6 mb-3">
									...
									<input type="text" class="form-control" name="url" placeholder="Website URL" required>
								  </div>
								  ...
								  <div class="col-md-12 mb-3">
									...
									<textarea name="address" rows="7" class="form-control" placeholder="Message"></textarea>
								  </div>
								...
								<a href="add_restaurant.php"><button type="button" class="waves-effect waves-light btn btn-dark mb-5"><i class=" ti-close"></i> Cancel</button></a>
